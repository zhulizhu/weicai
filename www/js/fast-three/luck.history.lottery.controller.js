...
(function () {
    ...
    angular
        .module('luck.history.lottery.controller', [])
        .controller('LuckHistoryLotteryCtrl',LuckHistoryLotteryCtrl);

    LuckHistoryLotteryCtrl.$inject = ['$scope','$yikeUtils','$state','$location','$ionicModal','localStorageService','$ionicPopup','$ionicViewSwitcher','$ionicLoading','$ionicScrollDelegate'];
    /* @ngInject */
    function LuckHistoryLotteryCtrl($scope,$yikeUtils,$state,$location,$ionicModal,localStorageService,$ionicPopup,$ionicViewSwitcher,$ionicLoading,$ionicScrollDelegate){
